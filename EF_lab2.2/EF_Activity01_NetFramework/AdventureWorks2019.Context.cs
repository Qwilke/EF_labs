...
namespace EF_Activity01_NetFramework
{
    ...
    public partial class AdventureWorks2019Entities : DbContext
    {
        ...
        [DbFunction("AdventureWorks2019Entities", "ufnGetContactInformation")]
        public virtual IQueryable<ufnGetContactInformation_Result> ufnGetContactInformation(Nullable<int> personID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetContactInformation_Result>("[AdventureWorks2019Entities].[ufnGetContactInformation](@PersonID)", personIDParameter);
        }
